...
export default function Header() {
  ...
  // Add a scroll event listener to change navbar background color
  useEffect(() => {
    const handleScroll = () => {
    ...
    <div className="container mx-0 flex justify-start items-center ">
      ...
      <form className="mx-auto max-w-xl py-2 px-6 rounded-full bg-gray-50 border flex focus-within:border-gray-300"
        ...
        >
          ...
          />
            <button className="hidden md:flex md:flex-row items-center justify-center min-w-[130px] px-4 rounded-full font-medium tracking-wide border transition ease-in-out duration-150 text-base bg-gradient-to-r from-orange-500 to-orange-900 text-white border-transparent py-1.5 h-[38px] -mr-3">
  Search
</button>
